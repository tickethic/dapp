  ...
  const testimonials = [
    {
      id: 1,
      name: "Marie Dubois",
      role: "Organisatrice &lsquo;événements",
    ...
    },
    {
      ...
      name: "Jean Martin",
      role: "Musicien",
      content: "Grâce à Tickethic, j'ai pu me concentrer sur ma musique tout en ayant une gestion transparente de mes participations et paiements. Une vraie bouffée &lsquo;air frais !",
    ...
    },
    {
      ...
      name: "Sophie Lambert",
      role: "Participante",
      content: "Je trouve toujours des événements intéressants sur Tickethic. L'achat de billets est simple et sécurisé, et je peux gérer toutes mes réservations en un clin &lsquo;œil.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={testimonial.id} className="bg-white p-8 rounded-xl shadow-sm border border-gray-100" data-aos="fade-up" data-aos-delay={index * 100}>
              ...
              <p className="text-gray-700 mb-4">&ldquo;{testimonial.content}&ldquo;</p>
